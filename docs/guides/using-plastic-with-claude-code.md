...
of hard stops: confirming a project path, or before an action with no safe way
back. You get the full story as it happens, but you are only pulled in when it
truly matters.
