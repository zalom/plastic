...
- **Skills**: the workflows agents follow (creating intents, brainstorming, writing plans, executing, releasing, indexing, and authoring skills, agents, and hooks via `plastic-skill-creating`). They produce the lifecycle artifacts in their fixed forms.
