...
projects/plastic/store/144--installer-default-channel-stable/plan.md     ... Installer first-[install] default channel (stable) ...
projects/plastic/store/144--installer-default-channel-stable/outcome.md  ... Installer first-[install] default channel (stable) ...
```
