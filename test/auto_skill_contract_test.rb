...
class AutoSkillContractTest < Minitest::Test
  ...
  # it backfills (spec D10). skills/intent-ending/SKILL.md said it was
  # hand-authored; the human contract side of this pin (test_ending_skill_names_the_generator's
  # human_contract half) still applies with intent-ending moved into `plastic intent end`
  # (intent 372, family 2) - the skill's own half is retired, its file is gone.
  def test_the_human_contract_names_outcome_md_as_generated
